            ...
            <div class="card tab2-card">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-material" id="account" role="tablist">
                        ...
                        @empty
                            <p>{{ __('static.sms_templates.no_languages_found') }}</p>
                        @endforelse
                    </ul>

                    <form method="POST" id="smsTemplatesForm" action="{{ route('backend.sms-template.update', @$slug) }}"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <label class="col-md-2 mb-2" for="title">
                                                                {{ __('static.sms_templates.title') }}<span>*</span>
                                                            </label>
                                                            <div class="col-md-10">
                                                                <input class="form-control" type="text"
                                                                    ...
                                                                    placeholder="{{ __('static.sms_templates.enter_title') }}">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-md-2 mb-2" for="content">
                                                                {{ __('static.sms_templates.content') }}<span>*</span>
                                                            </label>
                                                            <div class="col-md-10">
                                                                <textarea class="form-control content" placeholder="{{ __('static.sms_templates.enter_content') }}" rows="4"
    ...
    <script>
        (function($) {
            ...
            $('.add-shortcode').on('click', function() {
                ...
                // Insert the selected shortcode into the textarea
